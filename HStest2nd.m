...
% read data- edf for 2rdHS, with applying touv
[head, dset] = edfread('20201103_GL8214_TST_box2_APCR1_LSR2_dHCR3_S1L4.edf');
dset_1 = touv(dset(1,:)); % APCR %%%%%%%%%%%%%%%%%%%%%%%%%
dset_2 = touv(dset(2,:)); % dHCR %%%%%%%%%%%%%%%%%%%%%%%%
dset_3 = touv(dset(3,:)); % S1R %%%%%%%%%%%%%%%%%%%%%%%%%
dset_4 = touv(dset(4,:)); % S1L %%%%%%%%%%%%%%%%%%%%%%%%%
dset_5 = dset(5,:);       % volocity, in raw data structure
% select interested data
t0 = 10;       % set the time to split and pick data
dset_1 = segdata(dset_1, t0, 1000,400);
dset_2 = segdata(dset_2, t0, 1000,400);
dset_3 = segdata(dset_3, t0, 1000,400);
dset_4 = segdata(dset_4, t0, 1000,400);
dset_5 = segdata(dset_5, t0, 1000,400);
%% step 1.plot the data
% read data- edf for 2rdHS, with applying touv
[head, dset] = edfread('20201103_GL8214_TST_box2_APCR1_LSR2_dHCR3_S1L4.edf');
dset_1 = touv(dset(1,:)); % APCR %%%%%%%%%%%%%%%%%%%%%%%%%
...
% select interested data
t0 = 10;       % set the time to split and pick data
dset_1 = segdata(dset_1, t0, 1000,500);
dset_2 = segdata(dset_2, t0, 1000,500);
dset_3 = segdata(dset_3, t0, 1000,500);
dset_4 = segdata(dset_4, t0, 1000,500);
dset_5 = segdata(dset_5, t0, 1000,500);
...
Sxx = Sxx(:,1:N/2+1);		%Ignore negative frequencies.
Sxx_mn = mean(Sxx,1);			%Average spectra over trials.
...
figure
plot(faxis, Sxx_mn, 'LineWidth',3,'color','k')
